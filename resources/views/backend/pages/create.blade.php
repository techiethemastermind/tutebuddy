...
<div class="mdk-header-layout__content page-content ">
    ...
    <div class="page-section border-bottom-2">
        <div class="container page__container">
            ...
            {!! Form::open(['method' => 'POST', 'route' => ['admin.pages.store'], 'files' => true, 'id' => 'frm_pages']) !!}
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <input type="text" name="slug" class="form-control mb-24pt">
                    ...
                    <input type="text" name="meta_title" class="form-control mb-24pt">

                    <label class="form-label">Meta Description</label>
                    <textarea name="meta_description" class="form-control mb-24pt" rows="5"></textarea>

                    <label class="form-label">Meta Keywords</label>
                    <textarea name="meta_keywords" class="form-control mb-24pt"></textarea>
                </div>
    ...
    $('#frm_pages').on('submit', function(e) {
        ...
        $(this).ajaxSubmit({
            ...
            success: function(res) {
                if(res.success) {
                    var url = '/dashboard/pages/' + res.page_id + '/edit';
