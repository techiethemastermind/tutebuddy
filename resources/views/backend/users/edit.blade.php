...
<div class="mdk-header-layout__content page-content ">
    ...
    <div class="page-section container page__container">
        ...
        <!-- <div class="col-md-7 p-0">
            ...
            <div class="wrap d-none" for="user_pwd">
                <div class="form-group offset-3">
                    <div class="controls form-inline">
                        <label class="form-label col-lg-3 content-left">Password:</label>
                        <input class="form-control col-lg-8" type="text" name="password"
                            placeholder="New Password" value="">
                    </div>
                </div>
                <div class="form-group offset-3">
                    <div class="controls form-inline">
                        <label class="form-label col-lg-3 content-left">Confirm Password:</label>
                        <input class="form-control col-lg-8" type="text" name="confirm_password"
                            placeholder="Confirm Password" value="">
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-primary mt-24pt">Save changes</button>
