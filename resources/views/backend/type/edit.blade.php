        ...
        <div
            ...
            <div class="row" role="tablist">
                <div class="col-auto mr-3">
                    <a href="{{ route('admin.types.index') }}" class="btn btn-outline-secondary">Go To List</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-32pt">
            <div class="col-lg-7">
                <div class="page-separator">
                    <div class="page-separator__text">Edit Type</div>
                </div>
                <div class="flex" style="max-width: 100%">

                    {!! Form::model($type, ['method' => 'PATCH', 'id' => 'frm_edit', 'route' => ['admin.types.update', $type->id]]) !!}
