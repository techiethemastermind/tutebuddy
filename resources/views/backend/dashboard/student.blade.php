                        ...
                        <div class="card-body p-24pt">
                            <div class="chart" style="height: 344px;">
                                <canvas id="topicIqChart" class="chart-canvas js-update-chart-line"
                                    data-chart-hide-axes="true" data-chart-points="true" data-chart-suffix=" points"
                    ...
                    <div id="carouselExampleFade" class="carousel carousel-card slide mb-24pt">
                        <div class="carousel-inner">
                                ...
                                <a class="card border-0 mb-0" href="">
                                    ...
                                    <span
                                        ...
                                        <span class="row flex-nowrap">
                                            ...
                                            <span class="col d-flex flex-column">
                                                <span class="text-right flex mb-16pt">
                                                    <img src="{{ asset('assets/img/paths/flinto_40x40@2x.png') }}" width="64"
                                        ...
                                        <span class="row flex-nowrap">
                                            <span
                                                class="col-auto text-center d-flex flex-column justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/illustration/achievement/128/white.png') }}"
                            ...
                            <div class="carousel-item">
                                ...
                                <a class="card border-0 mb-0" href="">
                                    <img src="{{ asset('assets/img/achievements/angular.png') }}" alt="Angular fundamentals"
                                    ...
                                    <span
                                        ...
                                        <span class="row flex-nowrap">
                                            ...
                                            <span class="col d-flex flex-column">
                                                <span class="text-right flex mb-16pt">
                                                    <img src="{{ asset('assets/img/paths/angular_64x64.png') }}" width="64"
            ...
            <div class="row mb-lg-16pt">
                <div class="col-lg-6 mb-8pt mb-sm-0">
                    ...
                    <div class="card js-overlay card-sm overlay--primary-dodger-blue stack stack--1 mb-16pt"
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="fixed-student-path.html"
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <p class="mt-16pt text-black-70">Learn the fundamentals of working with Angular and how to
                            ...
                            <div class="mdk-carousel__content">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
                                        ...
                                        <a href="fixed-student-take-course.html" class="js-image" data-position="">
                                        ...
                                        <div class="mdk-reveal__content">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex">
                                                        <a class="card-title"
                                                            href="fixed-student-take-course.html">Learn Angular
                                                            fundamentals</a>
                                                        <small class="text-50 font-weight-bold mb-4pt">Elijah
                                                            Murray</small>
                                                    </div>
                                                    <a href="fixed-student-take-course.html" data-toggle="tooltip"
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="lh-1 mb-0">
                                                    ...
                                                    <span class="text-black-50 small font-weight-bold">Elijah
                                                        Murray</span>
                                                </p>
                                            </div>
                                        </div>

                                        <p class="my-16pt text-black-70">Learn the fundamentals of working with Angular
                                            and how to create basic applications.</p>

                                        <div class="mb-16pt">
                                            <div class="d-flex align-items-center">
                                                <span class="material-icons icon-16pt text-black-50 mr-8pt">check</span>
                                                <p class="flex text-black-50 lh-1 mb-0"><small>Fundamentals of working
                                                        with Angular</small></p>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span class="material-icons icon-16pt text-black-50 mr-8pt">check</span>
                                        ...
                                        <div class="my-32pt">
                                            <div class="d-flex align-items-center mb-8pt justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="material-icons icon-16pt text-black-50 mr-4pt">play_circle_outline</span>
                                                    <p class="flex text-black-50 lh-1 mb-0"><small>12 lessons</small>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-center">
                                                <a href="fixed-student-take-lesson.html"
                                        ...
                                        <div class="mdk-reveal__content">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex">
                                                        <a class="card-title"
                                                            href="fixed-student-take-course.html">Build an iOS
                                        ...
                                        <div class="mdk-reveal__content">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex">
                                                        <a class="card-title"
                                                            href="fixed-student-take-course.html">Build a WordPress
                                                            Website</a>
                                                        <small class="text-50 font-weight-bold mb-4pt">Elijah
                                                            Murray</small>
                                                    </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
                                        ...
                                        <a href="fixed-student-take-course.html" class="js-image" data-position="left">
                                        ...
                                        <div class="mdk-reveal__content">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex">
                                                        <a class="card-title"
                                                            href="fixed-student-take-course.html">Become a React Native
                                                            Developer</a>
                                                        <small class="text-50 font-weight-bold mb-4pt">Elijah
                                                            Murray</small>
                                                    </div>
                    ...
                    <div class="card card-group-row__card card-sm">
                        <div class="card-body d-flex align-items-center">
                            <a href="fixed-student-take-quiz.html"
                                ...
                                <img src="{{ asset('assets/img/paths/typescript_200x168.png') }}" alt="Introduction to TypeScript"
                                    class="avatar-img rounded">
                                <span class="overlay__content"></span>
                            </a>
                            <div class="flex mr-12pt">
                                <a class="card-title" href="fixed-student-take-quiz.html">Introduction to TypeScript</a>
                        ...
                        <div class="card-footer">
                            <div class="d-flex align-items-center">
                                <div class="flex mr-2">
                                    <a href="fixed-student-take-quiz.html" class="btn btn-light btn-sm">
                ...
                <div class="card-group-row__col col-md-6">
                    ...
                    <div class="card card-group-row__card card-sm">
                        <div class="card-body d-flex align-items-center">
                            <a href="fixed-student-take-quiz.html"
                                class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                                <img src="{{ asset('assets/img/paths/angular_200x168.png') }}" alt="Angular Fundamentals"
                                    class="avatar-img rounded">
                                <span class="overlay__content"></span>
                            </a>
                            <div class="flex mr-12pt">
                                <a class="card-title" href="fixed-student-take-quiz.html">Angular Fundamentals</a>
                                <div class="card-subtitle text-50">3 days ago</div>
                            </div>
                            <div class="d-flex flex-column align-items-center">
