                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex align-items-start p-16pt">
                                ...
                                <div class="flex">
                                    ...
                                    <p class="mb-0 text-50">Differentiate and you stand out in a crowded marketplace.
                                        Present your uniqueness and ...</p>
                            ...
                            <div class="list-group-item d-flex align-items-start p-16pt">
                                ...
                                <div class="flex">
                                    ...
                                    <p class="mb-0 text-50">A good logo works in the simplest form. It is a memorable
                                        representation of your brand and ...</p>
                                    <a href="" class="text-70 text-underline">read more</a>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body position-relative o-hidden p-0">
                            <div class="chart z-0" style="height: 110px;">
                                <canvas id="viewsChart" class="chart-canvas js-update-chart-line-2nd-accent"
...
<!-- Chart.js Samples -->
<script src="{{ asset('assets/js/page.erp-dashboard.js') }}"></script>
