                    ...
                    <div class="card m-0">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content_editor" name="editor" class="d-none"></textarea>
                            </div>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <div style="font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:center;color:#363A41;"
                                                                    align="center">
                                                                    <a id="preview_footer" href="{shop_url}"
    ...
    <script>
        $(function () {
            ...
            $('#btn_save').on('click', function(e) {
                ...
                $('textarea[name="editor"]').val(JSON.stringify(editor.getContents().ops));
                $('#frm_template').submit();
            });
