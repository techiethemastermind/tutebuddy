                    ...
                    <div class="media flex-nowrap">
                        <div class="media-left mr-16pt">
                            <a href="fixed-student-take-course.html">
                                <img src="{{ asset('assets/img/paths/angular_64x64.png') }}" width="40" alt="Angular"
                                    class="rounded"></a>
                        </div>
                        <div class="media-body d-flex flex-column">
                            <a href="fixed-student-take-course.html" class="card-title">Angular Fundamentals</a>
                            <div class="d-flex">
        ...
        <div class="container page__container">
            <nav class="course-nav">
                ...
                <a data-toggle="tooltip" data-placement="bottom" data-title="Quiz: Getting Started with Angular"
                    href="fixed-student-take-quiz.html"><span class="material-icons">hourglass_empty</span></a>
            </nav>
            ...
            <p class="hero__lead measure-hero-lead text-white-50 mb-24pt">JavaScript is now used to power backends,
                create hybrid mobile applications, architect cloud solutions, design neural networks and even control
                robots. Enter TypeScript: a superset of JavaScript for scalable, secure, performant and feature-rich
                applications.</p>
                ...
                <li class="nav-item navbar-list__item">
                    <div class="media align-items-center">
                        <span class="media-left mr-16pt">
                            <img src="{{ asset('assets/img/people/50/guy-6.jpg') }}" width="40" alt="avatar"
