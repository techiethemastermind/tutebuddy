                                ...
                                <div class="accordion__menu">
                                    <ul class="list-unstyled collapse @if($loop->iteration == 1) show @endif" id="toc-content-{{ $lesson->id }}">
                                        ...
                                        <li class="accordion__menu-link">
                                            <span class="material-icons icon-16pt icon--left text-body">adjust</span>
                                            <a class="flex" href="{{ route('admin.lessons.show', $lesson->id) }}">Take this lesson</a>
                                        ...
                                        <li class="accordion__menu-link">
                                            <span class="material-icons icon-16pt icon--left text-body">{{ $icons[$step['type']] }}</span>
                                            <a class="flex" href="{{ route('admin.lessons.show', $lesson->id) }}/?step={{ $step->step }}">
